...
const second_nav_wrap = document.getElementById("second_nav_wrap");
const nav_container = document.getElementById("nav_container");

function swapelements(condition) {
    if(condition){
        service_menu.style.maxHeight=0;
        ...
        second_nav_wrap.style.paddingTop = "120px";
